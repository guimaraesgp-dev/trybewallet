...
describe('', () => {
  it('Apresentar email para login', () => {
...
describe('', () => {
  it('Formulario de despesas', async () => {
...
describe('', () => {
  ...
  it('Adiciona despesas na tabela', async () => {
    global.fetch = jest.fn(async () => ({
      json: async () => mockData,
    }));
  ...
  it('Pegar e editar as despesas', async () => {
    global.fetch = jest.fn(async () => ({
      json: async () => mockData,
    }));
  ...
  it('Exclui despesas ao clicar no botão excluir', async () => {
    global.fetch = jest.fn(async () => ({
      json: async () => mockData,
    }));
...
describe('', () => {
  ...
  it('Edição de despesas ao clicar no botão', async () => {
    global.fetch = jest.fn(async () => ({
      json: async () => mockData,
    }));
